...
/////////////////////////////////////////////////////////////////////////////////
// <copyright file="IntensityGraphContent.xaml.cs"  company="Novartis Pharma AG.">
...
namespace Novartis.Msi.MSImageView
{
    ...
    /// <summary>
    /// Interaction logic for IntensityGraphContent.xaml
    /// </summary>
    public partial class IntensityGraphContent 
    {
        #region Fields
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="IntensityGraphContent"/> class
        /// </summary>
        /// <param name="data">Array containing Intensity values to be mapped</param>
        public IntensityGraphContent(float[] data)
        {
            InitializeComponent();
