...
/////////////////////////////////////////////////////////////////////////////////
// <copyright file="TiffWriter.cs" company="Novartis Pharma AG.">
...
{
    /// <summary>
    /// Encapsulates the tiff output functionality
    /// </summary>
    public class TiffWriter : BitmapWriter
    {
        #region Constructor
        ...
        /// <summary>
        /// Gets the name of the tiff writer.
        /// </summary>
        public override string Name
        {
            get { return "TIFF Writer"; }
        }
        ...
        /// <summary>
        /// Writes the bimap data specified by the given <see cref="BitmapSource"/> object TIFF format
        /// to the given stream.
        /// </summary>
        ...
        {
            this.SupportedFileTypes.Add(new FileTypeDescriptor(Strings.TiffFileDescription, ".tiff"));
        }
